...
export default function ModeratorEditBookPage() {
  ...
  if (isLoadingBook) return <div className="p-12 text-center text-sm text-gray-500">Loading...</div>;
    ...
    <div className="max-w-4xl mx-auto py-10 px-6">
      ...
      <form onSubmit={handleSubmit} className="space-y-10">
            ...
            <div>
              ...
              >
                ...
                <p className="text-[10px] font-bold text-gray-500">
                  {bookFile ? bookFile.name : "Replace Document"}
                </p>
              </div>
        ...
        <div className="flex justify-end pt-8 border-t border-gray-50 dark:border-neutral-800 space-x-4">
          ...
          <Button type="submit" isLoading={isUpdating} className="px-8 rounded-md uppercase text-[10px] font-bold tracking-widest">
            Save Changes
          </Button>
        </div>
      </form>
