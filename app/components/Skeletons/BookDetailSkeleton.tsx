      ...
      <div className="flex-1 flex flex-col">
        <div className="max-w-6xl mx-auto px-6 py-16 w-full grid lg:grid-cols-3 gap-16 animate-pulse">
          ...
          <div className="lg:col-span-2 space-y-12">
            ...
            <div className="bg-gray-50/50 dark:bg-neutral-800/30 p-8 rounded-lg border border-line-subtle space-y-8">
              <div className="space-y-2">
          ...
          <div className="space-y-8">
            <div className="h-64 bg-gray-50 dark:bg-neutral-800/50 rounded-lg border border-line-subtle" />
          </div>
        </div>
      </div>
    </div>
