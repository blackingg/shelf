        ...
        <div className="max-w-7xl mx-auto">
          <div className="mb-12">
            ...
            <div className="flex flex-col md:flex-row md:items-end justify-between gap-10">
              <div className="max-w-3xl flex-1">
                ...
                <div className="w-4/5 h-12 bg-gray-100 dark:bg-neutral-900 rounded-md animate-pulse mb-6" />
          ...
          <div className="flex flex-col md:flex-row items-center justify-between gap-6 mb-16">
            ...
            <div className="flex gap-4">
              <div className="w-44 h-12 bg-gray-50 dark:bg-neutral-900/50 rounded-md animate-pulse" />
              <div className="w-12 h-12 bg-gray-50 dark:bg-neutral-900/50 rounded-md animate-pulse" />
            </div>
          </div>
