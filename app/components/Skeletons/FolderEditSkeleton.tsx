  ...
  return (
    <div className="animate-pulse">
      <div className="max-w-5xl mx-auto px-4 md:px-6 py-8 md:py-12">
        {/* Back button */}
        <div className="h-5 bg-gray-100 dark:bg-neutral-800 rounded w-28 mb-8" />

        <div>
          {/* Header */}
          <div className="p-6 md:p-8 border-b border-gray-100 dark:border-white/5">
            <div className="flex items-center space-x-4">
              <div className="w-12 h-12 bg-gray-100 dark:bg-neutral-800 rounded-md" />
              <div className="space-y-2">
                <div className="h-7 bg-gray-200 dark:bg-neutral-800 rounded w-36" />
                <div className="h-4 bg-gray-100 dark:bg-neutral-800 rounded w-56" />
              </div>
            </div>
          </div>
          ...
          <div className="p-6 md:p-8 space-y-8">
            ...
            <div className="space-y-2">
              ...
              <div className="h-12 bg-gray-100 dark:bg-neutral-800 rounded-md w-full" />
            </div>

            {/* Description field */}
            <div className="space-y-2">
              <div className="h-4 bg-gray-100 dark:bg-neutral-800 rounded w-20" />
              <div className="h-28 bg-gray-100 dark:bg-neutral-800 rounded-md w-full" />
            </div>
            ...
            <div className="border-t border-gray-100 dark:border-white/5 pt-8 space-y-4">
              <div className="h-4 bg-gray-100 dark:bg-neutral-800 rounded w-28" />
              <div className="bg-gray-50 dark:bg-neutral-800/50 rounded-md p-4 md:p-6 space-y-4 border border-gray-100 dark:border-white/5">
                ...
                <div className="flex flex-col md:flex-row gap-4">
                  <div className="flex-1 h-10 bg-gray-100 dark:bg-neutral-800 rounded-md" />
                  <div className="w-32 h-10 bg-gray-100 dark:bg-neutral-800 rounded-md" />
                  <div className="w-24 h-10 bg-gray-200 dark:bg-neutral-700 rounded-md" />
                </div>
                {/* Collaborator rows */}
                {[1, 2].map((i) => (
                  <div
                  ...
                  >
                    <div className="flex items-center space-x-3">
                      ...
                      <div className="space-y-1.5">
                        ...
                        <div className="h-3 bg-gray-100 dark:bg-neutral-800 rounded w-14" />
                      </div>
                    </div>
                    <div className="w-8 h-8 bg-gray-100 dark:bg-neutral-800 rounded-md" />
                  </div>
            ...
            <div className="flex items-center justify-end space-x-4 pt-4 border-t border-gray-100 dark:border-white/5">
              <div className="h-12 bg-gray-100 dark:bg-neutral-800 rounded-md w-24" />
              <div className="h-12 bg-gray-200 dark:bg-neutral-700 rounded-md w-40" />
            </div>
          </div>
        </div>
      </div>
