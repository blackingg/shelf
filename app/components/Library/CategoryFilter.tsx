...
export const CategoryFilter: React.FC = () => {
  ...
  return (
    ...
    >
      ...
      <button className="flex items-center justify-center p-2 rounded-xl bg-gray-100 dark:bg-neutral-800 text-gray-700 dark:text-gray-300 hover:bg-gray-200 dark:hover:bg-neutral-700 transition-all duration-200">
