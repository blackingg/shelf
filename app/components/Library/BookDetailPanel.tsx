        ...
        {isOpen && (
          <>
            ...
            <motion.div
              ...
              className="fixed bg-[#072c0b] inset-x-0 top-0 bottom-0 h-full md:top-0 md:bottom-auto md:inset-x-auto md:right-0 md:h-full w-full md:w-lg max-w-full text-foreground p-4 sm:p-6 md:p-8 flex flex-col border-t md:border-t-0 md:border-l border-line z-50"
            >
              <button
                onClick={onClose}
              ...
              <div className="flex-1 overflow-y-auto custom-scrollbar pt-10 md:pt-12 pr-1">
                <div>
                  <div className="relative aspect-2/3 w-36 sm:w-44 md:w-56 mx-auto rounded-sm overflow-hidden border border-white/10 mb-6 md:mb-8 group">
                    <img
                      src={
                        book?.coverImage &&
                  ...
                  <div className="text-center mb-8 md:mb-10">
                    <h2 className="text-xl sm:text-2xl font-bold leading-tight mb-2 wrap-break-word px-2 text-white">
                      {book?.title}
                    </h2>
                    ...
                    {book?.donor?.username && (
                      <Link
                        ...
                        className="text-white text-xs sm:text-sm inline-block"
                        onClick={() => onClose()}
                      >
                        Donated by{" "}
                    ...
                    <div className="mt-5 md:mt-6 flex flex-col items-center">
                      <p className="text-[10px] text-white uppercase tracking-widest mb-3 font-bold">
                        Your Rating
                      </p>
                      <StarRating
                        rating={userRating}
                ...
                <div className="mb-10 md:mb-12">
                  <h3 className="text-[10px] font-black text-[#d0fdc2] uppercase tracking-widest mb-3 md:mb-4 flex items-center gap-2">
                ...
                <div className="border-t border-white/10 pt-6 md:pt-8 mb-6 md:mb-8">
                  <div className="flex items-center justify-between gap-3 mb-6 md:mb-8">
                    <h3 className="text-[10px] font-black text-[#d0fdc2] uppercase tracking-widest">
                      Reviews & Discussion
                    </h3>
                    <Link
              ...
              <div className="space-y-3 sm:space-y-4 mt-auto pt-5 md:pt-8 pb-[max(env(safe-area-inset-bottom),0.25rem)]">
                ...
                <div className="relative">
                  <button
                    onClick={() =>
                      typeof setShowFolderDropdown === "function" &&
                      setShowFolderDropdown(!showFolderDropdown)
                    }
                    className="w-full bg-white/5 hover:bg-white/10 text-[#d0fdc2] font-semibold py-3 px-4 sm:px-6 rounded-sm flex items-center justify-between transition-all duration-200 border border-white/10 hover:border-primary/50"
                  >
