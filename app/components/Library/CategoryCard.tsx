...
export const CategoryCard: React.FC<CategoryCardProps> = ({
  ...
  <div
    onClick={onClick}
    className="flex flex-col items-center md:items-start group cursor-pointer bg-background rounded-md p-5 border border-line hover:border-gray-300 dark:hover:border-neutral-700 transition-colors duration-150"
  >
    <div className="w-9 h-9 rounded-md bg-gray-100 dark:bg-neutral-800 flex items-center justify-center mb-3">
      <span className="text-base leading-none" aria-hidden="true">
        {category.icon || <FiGrid className="w-4 h-4" />}
      </span>
    </div>
