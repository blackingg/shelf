  ...
  return (
    <div className={className}>
      {isLoading && books.length === 0 ? (
        ...
        <div className="h-[30vh] text-center py-32 bg-gray-50/30 dark:bg-neutral-900/10 rounded-md border border-dashed border-line flex flex-col items-center justify-center">
          {emptyIcon || (
          ...
          <p className="text-sm font-bold uppercase tracking-widest text-faint mb-1">
            {emptyTitle}
          </p>
          {emptyMessage && (
