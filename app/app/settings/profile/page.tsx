                ...
                <form onSubmit={handleSubmit} className="space-y-8">
                  ...
                  <div className="space-y-1">
                    ...
                    <textarea
                      ...
                      value={formData.bio}
                      onChange={handleChange}
                      className="w-full px-4 py-2 rounded-xl border border-gray-200 focus:border-emerald-500 focus:ring-2 focus:ring-emerald-200 outline-none transition-all resize-none"
