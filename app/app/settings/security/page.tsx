        ...
        <div className="p-6 md:p-8 space-y-16">
          {/* <div>
            <div className="flex items-center space-x-3 mb-6">
              <FiKey className="w-5 h-5 text-gray-400 dark:text-gray-500" />
          ...
          <div className="border-t border-gray-200 dark:border-gray-800">
            <div className="flex items-center space-x-3 mb-6">
              <FiShield className="w-5 h-5 text-gray-400 dark:text-gray-500" />
              <h3 className="text-lg font-semibold text-gray-900 dark:text-white">
                Active Sessions
              </h3>
            </div>
            <div className="space-y-4">
              <div className="flex items-center justify-between p-4 border border-gray-200 dark:border-gray-700 rounded-xl bg-gray-50 dark:bg-neutral-800">
                <div>
              ...
              <div className="flex items-center justify-between p-4 border border-gray-200 dark:border-gray-700 rounded-xl dark:bg-neutral-800/50">
                <div>
                  <div className="font-medium text-gray-900 dark:text-white">
                    iPhone 13 - Safari
                  </div>
