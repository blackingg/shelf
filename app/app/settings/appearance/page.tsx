        ...
        <div className="p-6 md:p-8 space-y-8">
          <div>
            ...
            <div className="grid grid-cols-1 sm:grid-cols-3 gap-4">
              <button
                ...
                className={`flex flex-col items-center p-4 rounded-xl border-2 transition-all ${
                  theme === "light"
                    ...
                    : "border-gray-200 dark:border-gray-700 hover:border-gray-300 dark:hover:border-gray-600 dark:bg-neutral-800"
                }`}
              >
              ...
              >
                <div className="p-3 bg-gray-100 dark:bg-gray-700 rounded-full shadow-sm mb-3">
                  <FiMonitor className="w-6 h-6 text-gray-700 dark:text-gray-300" />
                </div>
                <span className="font-medium text-gray-900 dark:text-white">
                  System
                </span>
