...
export default function AdminEditBookPage() {
  ...
  const Label = ({ children }: { children: React.ReactNode }) => (
    <label className="text-[11px] uppercase font-medium tracking-wider text-faint mb-2 block">
      {children}
    </label>
  );
          ...
          <div className="space-y-6">
            <div>
              ...
              <div
                ...
                className="aspect-[3/4] border border-line-subtle rounded-md overflow-hidden cursor-pointer hover:border-primary/50 transition-colors relative group"
              >
                {coverPreviewUrl ? (
            ...
            <div>
              ...
              <div
                ...
                className="p-4 border border-dashed border-line-subtle rounded-md text-center cursor-pointer hover:border-primary/50 transition-colors"
              >
          ...
          <div className="md:col-span-2 space-y-6">
            <div className="space-y-1.5">
              ...
              <input
                ...
                className="w-full px-4 py-2.5 bg-background border border-line-subtle rounded-md text-sm outline-none focus:border-primary/50"
                required
              />
            </div>
            ...
            <div className="space-y-1.5">
              ...
              <textarea
                ...
                className="w-full px-4 py-2.5 bg-background border border-line-subtle rounded-md text-sm outline-none focus:border-primary/50 resize-none"
                required
              />
            </div>
