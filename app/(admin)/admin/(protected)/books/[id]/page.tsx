...
import AdminBookDetailSkeleton from "@/app/components/Skeletons/Admin/AdminBookDetailSkeleton";
...
export default function AdminBookDetailPage() {
  ...
  if (isLoading) return <AdminBookDetailSkeleton />;
    ...
    <div className="max-w-4xl mx-auto py-10 px-6 space-y-12">
        ...
        <div className="flex-1 space-y-6">
          ...
          <div className="flex items-center gap-4">
            <Link 
              ...
              className="flex items-center gap-2 px-6 py-2 bg-primary text-primary-foreground rounded-md text-xs font-medium uppercase tracking-widest hover:opacity-90 transition-colors"
            >
              <FiBookOpen />
            ...
            <Link 
              ...
              className="flex items-center gap-2 px-6 py-2 bg-red-600 text-white rounded-md text-xs font-medium uppercase tracking-widest hover:bg-red-700 transition-colors"
            >
              <FiEdit3 />
      ...
      <div className="grid md:grid-cols-2 gap-12 border-t border-gray-50 dark:border-neutral-800 pt-10">
        <div className="space-y-6">
          <h3 className="text-xs font-medium uppercase tracking-widest text-gray-400">System Metadata</h3>
        ...
        <div className="space-y-6">
          <h3 className="text-xs font-medium uppercase tracking-widest text-gray-400">Contributor Governance</h3>
          <div className="space-y-4">
